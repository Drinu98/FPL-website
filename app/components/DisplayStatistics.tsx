...
const DisplayStatistics = (props: DisplayTransfersProps) => {
  ...
  const [selectedProperty, setSelectedProperty] = useState<keyof Player>(
    "selected_by_percent"
  );
  ...
  const positions = Array.from(
    new Set(playerData.map((player) => player.position_long))
  );
  ...
  useEffect(() => {
    ...
    if (selectedFilter) {
      filteredData = filteredData.filter(
        (player) =>
          player.position_long === selectedFilter ||
          player.team === selectedFilter
      );
    }
    ...
    <div className="transfers-container">
      ...
      <div style={{ overflowY: "auto", overflowX: "hidden" }}>
        ...
        <select
          ...
          className="statistics-select select"
        >
          ...
          <tbody className="transfers-body">
            {sortedAndFilteredData.map((player, index) => (
              <tr key={index} className="table-row">
                ...
                <td className="player-info" style={{ textAlign: "left" }}>
                  {player[selectedProperty].toLocaleString()}
                </td>
              </tr>
            ))}
          </tbody>
