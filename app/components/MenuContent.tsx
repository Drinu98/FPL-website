...
import { faArrowRight, faBullseye, faCrown, faCrutch, faHome, faMoneyBillTransfer, faPerson, faPersonCircleXmark, faPlus, faUpRightAndDownLeftFromCenter } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div className="menu-content">
      ...
      <ul style={{listStyle: 'none'}}>
        ...
        <a href='/expected'>Expected Data <FontAwesomeIcon icon={faBullseye} /></a>
      </ul>
    </div>
  );
}
