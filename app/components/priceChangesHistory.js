...
async function getPriceChanges(){
  ...
  const sortedFixtures = updatedDates?.sort((a, b) => Date.parse(b.date) - Date.parse(a.date));
      ...
      <div key={date}>
        <div className="fixture-date-box">
            <span className="fixture-date-inner-box">
                <h4 style={{marginBottom:'0'}} className="fixture-date">{date}</h4>
            </span>
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', height: '100%' }}>
            ...
            <table style={{ width: '100%', marginLeft: 5 }} className="transfers-table-playerchanges">
              <thead>
                <tr>
                  ...
                  <th className="transfer-header" style={{ textAlign: 'left', paddingTop:'8px' }}>Name</th>
                  <th className="transfer-header"></th>
                  <th className="transfer-header" style={{ textAlign: 'left', paddingTop:'8px' }}>Team</th>
                  <th className="transfer-header" style={{ textAlign: 'left', paddingTop:'8px' }}>Cost</th>
                </tr>
              </thead>
              <tbody>
                {players
                  ...
                  {players.filter(player => player.type === "riser").length === 0 && (
                  <tr>
          ...
          <div style={{ flex: 1, borderLeft: '1px solid rgba(55, 0, 60, 0.08)', paddingRight:'5px'}}>
            <table style={{ width: '100%', marginLeft: 5 }} className="transfers-table-playerchanges">
              <thead>
                <tr>
                  <th className="transfer-header"></th>
              ...
              <tbody>
                {players
                  ...
                  {players.filter(player => player.type === "faller").length === 0 && (
                  <tr>
                    <td colSpan="5" style={{ marginLeft: 10, fontSize: 12 }}>
                      No price falls
                    </td>
